...
def build_inspection_lines(manifest: dict[str, object]) -> list[str]:
    ...
    if isinstance(diagnostics, dict):
        ...
        lines.append(f"candidate_density: {diagnostics.get('candidate_density')}")
        lines.append(f"fused_candidate_count: {diagnostics.get('fused_candidate_count')}")
        lines.append(f"returned_candidate_count: {diagnostics.get('returned_candidate_count')}")
