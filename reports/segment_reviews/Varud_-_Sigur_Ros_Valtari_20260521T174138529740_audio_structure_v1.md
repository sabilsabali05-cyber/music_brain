...
- manifest_path: `<PRIVATE_LOCAL_PATH>/ai-composer/music_brain/samples/segments/Varud_-_Sigur_Ros_Valtari/20260521T174138529740_audio_structure_v1/segments_manifest.json`
- run_id: `20260521T174138529740_audio_structure_v1`
...
- segmentation_parameters: `{'boundary_threshold': 0.55, 'min_segment_seconds': 24.0, 'max_segment_seconds': 90.0, 'rms_weight': 0.1, 'onset_weight': 0.15, 'chroma_weight': 0.4, 'timbre_weight': 0.35, 'allow_fixed_candidates': False}`
...
| 3 | 180.0 | 220.0 | 40.0 | 0.567 | onset_density_change | combined_novelty=0.586, chroma_change=0.540, timbre_change=0.502, onset_change=0.605, energy_change=0.085 | seg_0002 | seg_0004 | win_0003 |
...
| 220.000 | 0.586 | onset_density_change | rejected_or_unused | combined_novelty=0.586, chroma_change=0.540, timbre_change=0.502, onset_change=0.605, energy_change=0.085 |
...
- confidence_range: min=`0.16`, max=`0.56691`
- confidence_mean: `0.227818`
- rejection_reason_counts: `{'fixed_interval_candidate': 5, 'accepted': 1}`

### Top 10 Rejected Candidates by Confidence

| time_seconds | tuned_confidence | rejection_reason | boundary_reason | evidence |
|---:|---:|---|---|---|
| 60.0 | 0.16 | fixed_interval_candidate | fixed_interval_fallback | combined_novelty=0.200, chroma_change=0.000, timbre_change=0.000, onset_change=0.000, energy_change=0.000 |
| 120.0 | 0.16 | fixed_interval_candidate | fixed_interval_fallback | combined_novelty=0.200, chroma_change=0.000, timbre_change=0.000, onset_change=0.000, energy_change=0.000 |
| 180.0 | 0.16 | fixed_interval_candidate | fixed_interval_fallback | combined_novelty=0.200, chroma_change=0.000, timbre_change=0.000, onset_change=0.000, energy_change=0.000 |
| 280.0 | 0.16 | fixed_interval_candidate | fixed_interval_fallback | combined_novelty=0.200, chroma_change=0.000, timbre_change=0.000, onset_change=0.000, energy_change=0.000 |
| 340.0 | 0.16 | fixed_interval_candidate | fixed_interval_fallback | combined_novelty=0.200, chroma_change=0.000, timbre_change=0.000, onset_change=0.000, energy_change=0.000 |
