...
class EssentiaAdapter:
    ...
    def configured(self) -> bool:
        ...
        return (
            ...
            and self._is_real_value(settings.get("package_required"))
    ...
    def run_smoke_test(self) -> tuple[bool, str]:
        ...
        package_name = str(settings.get("package_required", "essentia")).strip() or "essentia"
        try:
            importlib.import_module(package_name)
        except ModuleNotFoundError:
            return False, f"dependency_missing:{package_name}"
        except Exception:  # noqa: BLE001
            return False, f"dependency_probe_failed:{package_name}"
    ...
    def availability(self) -> dict[str, Any]:
        ...
        return {
            ...
            "reason": reason,
            "role": "baseline_descriptor_witness",
            "notes": [
                "No audio processing is executed by this adapter.",
                "No downloads and no model training are performed.",
            ],
        }
